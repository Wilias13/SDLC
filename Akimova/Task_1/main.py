...
def work_with_file():
    ...
    choose(len(MENU_FILE), switch_work_with_files)


def work_with_json():
    print_menu(MENU_JSON)
    choose(len(MENU_JSON), switch_work_with_json)


def work_with_xml():
    print_menu(MENU_XML)
    choose(len(MENU_XML), switch_work_with_xml)


def work_with_zip():
    print_menu(MENU_ZIP)
    choose(len(MENU_ZIP), switch_work_with_zip)
